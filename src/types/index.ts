...
export type TaskDisplayAs = 'task' | 'deadline' | 'event' | 'habit';
...
export interface ChecklistItem {
  ...
  // Display-as fields (populated when displayAs is 'deadline', 'event', or 'habit')
  ...
  habitColor?: string;
  habitNotificationEnabled?: boolean;
  habitNotificationTime?: { hour: number; minute: number };
